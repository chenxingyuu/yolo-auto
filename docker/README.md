...
| `YOLO_MODELS_DIR` | `/workspace/models` | 预训练 base model（镜像构建时已下载 yolov8n/s/m/l/x.pt） |
...
- Python 与 Ultralytics 来自基础镜像；预创建 `/workspace/yolo-auto`、`/workspace/datasets`、`/workspace/jobs`、`/workspace/models`。
